  ...
  return (
    <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            <img
              ...
              style={{ width: "50%" }}
            />
            <p>&copy; 2026 TradeSphere. All rights reserved.</p>
          </div>
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          <p>
            TradeSphere is a stock trading platform project built for
            educational and demonstration purposes. It does not provide real
            brokerage, investment, or financial services.
          </p>

          <p>
            Investments in securities markets are subject to market risks.
            Please review relevant information and consult a qualified
            financial professional before making investment decisions.
          </p>
        </div>

        <div
          className="row mt-2 mb-3 text-muted"
          style={{ fontSize: "14px" }}
        >
          <div className="col text-center">
            <a href="">Terms & conditions</a> &nbsp; &nbsp;
